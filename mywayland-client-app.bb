...
DEPENDS += "wayland freeglut"

IMAGE_INSTALL += "libstdc++ mtd-utils libdrm libegl" 
IMAGE_INSTALL += "openssh openssl openssh-sftp-server" 
IMAGE_INSTALL += " git make pkgconfig libdrm-dev libgl-mesa-dev libegl-mesa-dev mesa-dev"
IMAGE_INSTALL += "sudo gcc g++ binutils coreutils bash"
